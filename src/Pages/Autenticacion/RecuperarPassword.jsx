...
import CerrarVentana from "../../Components/Autenticacion/CerrarVentana";
  ...
  return (
    <>
      ...
      >
        ...
        <div className="text-white bg-white/0 backdrop-blur-xl rounded-3xl shadow-2xl shadow-black/40 p-8 w-[350px] flex flex-col items-center border border-white/10">
          {enviado ? (
            <CerrarVentana />
          ) : (
            <>
              ...
              <div className="pb-8 text-center">
                ...
                <p className="text-white/80 text-sm leading-relaxed px-2">
                  ...
                  enlace para restablecer tu contraseña de forma segura.
                </p>
              </div>
